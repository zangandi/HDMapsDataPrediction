...
%
% out_dir = 'G:\run_0119\';
% dir_list = {'5lstm-exp1','5lstm-exp2','5lstm-exp3','5lstm-exp4','5lstm-exp5','5lstm-exp6'};
...
% load('.\results\6_stages_results_run0113.mat')
load('.\results\step5.mat')
%
% a1 = load('G:\run_0121\511.mat');
% a2 = load('G:\run_0121\512.mat');
% a3 = load('G:\run_0121\513.mat');
% a4 = load('G:\run_0121\514.mat');
%
...
plot([1:100], median_mdc(3,:),'c-');
plot([1:100], median_mdc(4,:),'m-');
% plot([1:100], median_mdc(5,:),'g-');
% plot([1:100], median_mdc(6,:),'c-');
plot([1:100],ones(1,100), 'k--');
% legend({'B w/o', 'B w/', 'A w/o', 'A w/', 'T w/o', 'T w/'});
legend({'5B0+fLSTM', '5B1+fLSTM', '5A0+fLSTM', '5A1+fLSTM', 'reference line:y=1'});
...
% plot([1:L],median_mdc(4,:), 'r-', 'linewidth', 3);
% plot([1:L], ones(1,L), 'k--');
% legend({'AF w/','reference line:y=1'});
% ylim([0 2])
% xlim([0 L])
% xlabel('Normalized trip progress (%)')
